...
public class CreateWorldScreen extends Screen {
    ...
    private final TabManager tabManager = new TabManager(this::addRenderableWidget, p_267853_ -> this.removeWidget(p_267853_));
    ...
    public static CreateWorldScreen createFromExisting(
        ...
        CreateWorldScreen createworldscreen = new CreateWorldScreen(
            ...
            p_276029_,
            p_276028_,
            WorldPresets.fromSettings(p_276028_.selectedDimensions().dimensions()),
    ...
    protected void init() {
        ...
        gridlayout$rowhelper.addChild(Button.builder(Component.translatable("selectWorld.create"), p_232938_ -> this.onCreate()).build());
        gridlayout$rowhelper.addChild(Button.builder(CommonComponents.GUI_CANCEL, p_232903_ -> this.popScreen()).build());
                ...
                p_247793_ -> {
                    if (p_247793_.datapackWorldgen().registryOrThrow(Registries.WORLD_PRESET).size() == 0) {
                        ...
                        return new WorldLoader.DataLoadOutput<>(
                            new CreateWorldScreen.DataPackReloadCookie(worldgensettings, p_247793_.dataConfiguration()), p_247793_.datapackDimensions()
                        );
                    }
                },
        ...
        GameTab() {
            ...
            CycleButton<Boolean> cyclebutton2 = gridlayout$rowhelper.addChild(
                CycleButton.onOffBuilder()
                    .withTooltip(p_267952_ -> Tooltip.create(CreateWorldScreen.ALLOW_CHEATS_INFO))
                    .create(0, 0, 210, 20, ALLOW_CHEATS, (p_268200_, p_268324_) -> CreateWorldScreen.this.uiState.setAllowCheats(p_268324_))
            );
