...
public class Camera {
    ...
    private double getMaxZoom(double p_90567_) {
        for(int i = 0; i < 8; ++i) {
            ...
            Vec3 vec31 = new Vec3(
                this.position.x - (double)this.forwards.x() * p_90567_ + (double)f,
                this.position.y - (double)this.forwards.y() * p_90567_ + (double)f1,
                this.position.z - (double)this.forwards.z() * p_90567_ + (double)f2
            );
    ...
    protected void setRotation(float p_90573_, float p_90574_) {
        this.xRot = p_90574_;
        this.yRot = p_90573_;
        this.rotation.rotationYXZ(-p_90573_ * (float) (Math.PI / 180.0), p_90574_ * (float) (Math.PI / 180.0), 0.0F);
